...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--scheduled_sampling', action='store_true', default = False, help='whether saves model by iteration')
        parser.add_argument('--sampling_starting_epoch', type=int, default = 180, help='when to start scheduled sampling')
        parser.add_argument('--label', type=str, default = 'Happiness', help='saving class label')
        # training parameters
        parser.add_argument('--guide_iter', type=int, default=60, help='# of iter at starting learning rate')
